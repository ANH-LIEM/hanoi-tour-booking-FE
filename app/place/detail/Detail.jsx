            ...
            <div className="space-y-4">
                ...
                <div className="border border-gray-300 p-4 rounded-md mx-auto center mt-6">
                    ...
                    <div className="tour-info-section">
                        <ul>
                            <li><b>場所</b> {placeInfo.location}</li>
                        </ul>
                    </div>
                </div>

                <div className="border border-gray-300 p-4 rounded-md mx-auto center mt-6">
                    <label htmlFor="place-describe" className="block text-sm font-medium leading-6 text-gray-900">
                        <b className="text-lg">詳細な説明</b>
                    </label>
                    <br />
                    <div className="place-describe-section">
